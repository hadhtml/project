                ...
                <div class="card-body p-0">
                    ...
                    <div>
                                                                                                        ...
                                                                                                        <div class="container-scroll"
                                                                                                            ...
                                                                                                            @if (count($quarter) > 0)
                                                                                                                @foreach ($quarter as $q)
                                                                                                                    @php
                                                                                                                        $quarterMonth = DB::table('quarter_month')
                                                                                                                            ->where('quarter_id', $q->id)
                                                                                                                            ->get();
                                                                                                                        $quarterMonthCount = DB::table('quarter_month')
                                                                                                                            ->where('quarter_id', $q->id)
                                                                                                                            ->count();
                                                                                                                    @endphp
                                                                                                                                            ...
                                                                                                                                            <div
                                                                                                                                                ...
                                                                                                                                                @if (count($quarterMonth) > 0)
                                                                                                                                                    @foreach ($quarterMonth as $month)
                                                                                                                                                        @php
                                                                                                                                                       $epic  = DB::table('epics')->where('month_id',$month->id)->where('trash',NULL)->whereIn('team_id',$FladId)->get();
                                                                                                                                                        @endphp
                                                                                                                                                        <div @if ($CurrentQuarter) @if ($q->id < $CurrentQuarter->quarter_id) class="board-flex" @else class="board" @endif
                                                                                                                                                            @endif
                                                                                                                                                            style="width:236px"
                                                                                                                                                            id="{{ $month->id }}">
                                                                                                                                                            <header
                        ...
                        <div class="row py-2">
                            <div class="col-md-12">
                                <a href=""
                                    onclick="objective({{ $obj->id }},'{{ $keyweightcount }}','{{ $obj->start_date }}','{{ $obj->end_date }}')"
                                    data-toggle="modal" data-target="#create-key-result"
