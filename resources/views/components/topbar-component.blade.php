<nav class="navbar navbar-expand-lg navbar-light bg-light main-topbar align-items-center">
    <a class="navbar-brand" href="#">
        ...
        height: 40px;
        object-fit: contain;" class="d-inline-block align-top" alt="">
        <img src="{{asset('public/assets/images/icons/logo-2.png')}}"style="width:120px;
        height: 40px; object-fit:contain" class="d-inline-block align-top" alt="">
    ...
    <!-- <div class="d-flex align-items-stretch justify-content-between">
        ...
        <div>
            <div class="d-flex flex-row nav-action align-items-center">
                <div class="mr-2">
                    <button class="btn-circle btn-md bg-trans" id="openSidebarBtn" onclick="toggleSidebar('open')">
