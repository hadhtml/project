...
@section('content')
    @php
        ...
        $Portfolio = DB::table('objectives')
            ->where('type', 'org')
            ->where('unit_id', $organization->id)
            ->where('trash', null)
            ->count();
        $Performance = DB::table('kpi_setting')
            ->where('stream_id', $organization->id)
            ->where('type', 'org')
            ->count();
        $Teams = DB::table('org_team')
            ->where('org_id', $organization->id)
            ->count();
        $Reporting = DB::table('sprint')
            ->where('value_unit_id', $organization->id)
            ->where('type', 'org')
            ->count();
            ...
            <div class="row">
                <div class="col-md-3 mb-4">
                    <div class="dashboard-card">
                        <div class="card-svg">
                            <a
                                href="{{ url('dashboard/organization/' . $organization->slug . '/portfolio/' . $organization->type) }}">
                                <img src="{{ url('public/assets/svg/portfoliosvg.svg') }}"></a>
                        </div>
                ...
                <div class="col-md-3 mb-4">
                    <div class="dashboard-card">
                        <div class="card-svg">
                            <a href="{{ url('dashboard/organization/' . $organization->slug . '/BT-Backlog/org') }}"> <img
                                    src="{{ url('public/assets/svg/epicsbacklogsvg.svg') }}"></a>
                        </div>
                        <div class="dashboard-card-tittle">
                            <h4>Epics Backlog</h4>
                        </div>
                ...
                <div class="col-md-3 mb-4">
                    <div class="dashboard-card">
                        <div class="card-svg">
                            <a
                                href="{{ url('dashboard/organization/' . $organization->slug . '/performance-dashboard/' . $organization->type) }}">
                ...
                <div class="col-md-3 mb-4">
                    <div class="dashboard-card">
                        <div class="card-svg">
                            <a href="{{ url('dashboard/organization/' . $organization->slug . '/Org-TEAMS') }}"> <img
                                    src="{{ url('public/assets/svg/teamssvg.svg') }}"></a>
                        </div>
                        <div class="dashboard-card-tittle">
                            <h4>Teams</h4>
                        </div>
                ...
                <div class="col-md-3 mb-4">
                    <div class="dashboard-card">
                        <div class="card-svg">
                            <a
                                href="{{ url('dashboard/organization/' . $organization->slug . '/BU-Report/' . $organization->type) }}">
                                <img src="{{ url('public/assets/svg/reportingsvg.svg') }}"></a>
                        </div>
                        <div class="dashboard-card-tittle">
                            <h4>Reporting</h4>
                        </div>
