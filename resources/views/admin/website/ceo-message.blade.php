                    ...
                    <div class="d-flex align-items-center flex-wrap mr-1">
                        <div class="d-flex align-items-baseline flex-wrap mr-5">
                            <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">
                                ...
                                <li class="breadcrumb-item">
                                    <a href="javascript::void(0)" class="text-muted">Message Section</a>
                                </li>
                ...
                <div class="card-header flex-wrap py-5">
                    <div class="card-title">
                        <h3 class="card-label">
                            ...
                            <div class="text-muted pt-2 font-size-sm">CEO Message Section</div>
                        </h3>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-6">
                            <form  method="POST" action="{{ url('admin/save-message') }}" enctype="multipart/form-data">
                                @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <label>Message</label>
                                     <textarea col="3"  name="message"  class="form-control" required> @if($data) {{$data->message}} @endif </textarea>
                                </div>
