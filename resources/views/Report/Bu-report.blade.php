    ...
    <div class="modal-dialog modal-dialog-centered mw-650px" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                ...
                <div class="text-center mb-13">
                  <h1 class="mb-3" id="end-quartr">Start Quarter</h1>
               </div>
                <div class="row">
                    <div class="col-md-12">
                        <div id="success-sprint"  role="alert"></div>
...
=======
            '<div class="alert alert-success" role="alert">Quarter Ended successfully</div>'
>>>>>>> 3e9080c (Committing local changes before merge)
        );
        setTimeout(function() {
          location.reload();
        }, 2000);
...
$.ajax({
    ...
    success: function(res) {
        ...
        $('#success-sprint').html(
            '<div class="alert alert-success" role="alert">Quarter Added successfully</div>'
        );
        setTimeout(function() {
