...
<header class="header-area style-6">
            <div class="container-lg container-fluid d-flex flex-nowrap align-items-center justify-content-between">
                ...
                <div class="main-menu">
                    <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                        <div class="mobile-logo-wrap">
                            <a href="#"><img alt="Outcomemet" src="{{asset('public/assetsindex/assets/img/software-logo.svg')}}" /></a>
                        </div>
                    </div>
                    <ul class="menu-list">
                        <li><a href="{{url('/')}}">Home</a></li>
                ...
                <div class="nav-right d-flex jsutify-content-end align-items-center">
                    ...
                    @endif
                    @if (Auth::check())
                    <a href="javascript:void(0)" class="primary-btn3 btn-hover d-md-flex d-none">
                        Get Started
                        <span></span>
                    </a>
                    @else
