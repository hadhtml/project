                                                ...
                                                <tbody>
                                                   ...
                                                   @foreach($Team as $team)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="image-cell"><img id="gixie" alt="gixie" width="20" height="20" /><a class="nav-link" href="{{url('dashboard/organization/'.$team->slug.'/portfolio/BU')}}">{{$team->team_title}}</a></td>
...
var imageData = new GIXI(100).getImage();
