...
$Impediments = DB::table('flags')->where('flag_status','!=','doneflag')->where('flag_type','Impediment')->where('business_units',$organization->id)->where('flag_title','!=',NULL)->where('board_type','BU')->count();
}
...
$Impediments = DB::table('flags')->where('flag_status','!=','doneflag')->where('flag_type','Impediment')->where('business_units',$organization->id)->where('flag_title','!=',NULL)->where('board_type','VS')->count();
}
