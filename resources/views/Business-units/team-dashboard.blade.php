...
$Impediments = DB::table('flags')->where('business_units',$organization->id)->where('board_type','BU')->count();
}
...
$Impediments = DB::table('flags')->where('business_units',$organization->id)->where('board_type','VS')->count();
}
...
$Impediments = DB::table('flags')->where('business_units',$organization->id)->where('board_type','orgT')->count();
}
