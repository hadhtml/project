@php
$var_objective = "Org-Unit-dashboard";
@endphp
...
$Performance = DB::table('kpi_setting')->where('stream_id',$organization->id)->where('type','unit')->count();
...
$Impediments = DB::table('flags')->where('business_units',$organization->id)->where('flag_type','Impediment')->where('board_type','unit')->count();
    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-3 mb-4">
                <div class="dashboard-card">
                    <div class="card-svg">
                        <a href="{{url('dashboard/organization/'.$organization->slug.'/BU-Backlog')}}"> <img src="{{ url('public/assets/svg/epicsbacklogsvg.svg') }}"></a>
                    </div>
                    <div class="dashboard-card-tittle">
                        <h4>Epics Backlog</h4>
                    </div>
            ...
            <div class="col-md-3 mb-4">
                <div class="dashboard-card">
                    <div class="card-svg">
                        <a href="{{url('dashboard/organization/'.$organization->slug.'/BU-TEAMS')}}"> <img src="{{ url('public/assets/svg/teamssvg.svg') }}"></a>
                    </div>
                    <div class="dashboard-card-tittle">
                        <h4>Teams</h4>
                    </div>
            ...
            <div class="col-md-3 mb-4">
                <div class="dashboard-card">
                    <div class="card-svg">
                        <a href="{{url('dashboard/flags/'.$organization->slug.'/impediments/unit')}}" > 
