...
@section('content')
                                                ...
                                                <div class="modal-content" style="width: 526px !important;">
                                                    ...
                                                    <div class="modal-body">
                                                        <form class="needs-validation"
                                                            action="{{ url('assign-backlog-epic') }}" method="POST">
                                                            @csrf
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content" style="width: 526px !important;">
                                                <div class="modal-header">
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <h5 class="modal-title" id="create-epic">Update Backlog Epic
                                                            </h5>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <p>Fill out the form, submit and hit the save button.</p>
                                                ...
                                                <div class="modal-body">
                                                    <form class="needs-validation"
                                                        action="{{ url('update-backlog-epic') }}" method="POST">
                                                        @csrf
                                                        <input type="hidden" name="backlog_id"
                                                            value="{{ $backlog->id }}">
                                                        <div class="row">
                                                            <div class="col-md-12 col-lg-12 col-xl-12">
                                                                <div class="form-group mb-0">
                                                                    <input type="text" class="form-control"
                                                                        value="{{ $backlog->epic_title }}"
                                                                        name="epic_name" id="" required>
    ...
    <div class="modal fade" id="assign-backlog-epic" tabindex="-1" role="dialog" aria-labelledby="create-epic"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content" style="width: 526px !important;">
                <div class="modal-header">
                    ...
                    <form class="needs-validation" action="{{ url('assign-jira-epic') }}" method="POST">
                        ...
                        @else
                            <div class="alert alert-danger mt-1 ml-3" role="alert">
                                Connect your Jira account in the settings. <a
                                    href="{{ url('dashboard/organization/setting') }}" class="alert-link">Click here</a>.
                            </div>
                        @endif
                        <div class="col-md-12 col-lg-12 col-xl-12">
                            <div class="form-group mb-0">
