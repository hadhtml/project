    ...
    <div class="col-md-12 col-lg-12 col-xl-12 @if($epicstory->count() > 1) paddingrightzero @endif">
        <div class="d-flex flex-row align-items-center justify-content-between block-header">
            ...
            <div class="displayflex">
                ...
                <span data-toggle="collapse" data-target="#addstory" aria-expanded="false" aria-controls="addstory" class="btn btn-primary btn-sm" id="ButtonCollaps">Add</span>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group mb-0">
                            <label for="objective-name">Item Title</label>
