...
<div class="row mt-4 uploadattachment">
    <div class="col-md-12 col-lg-12 col-xl-12">
        <form class="classcreatechilditemform" method="POST" action="{{ url('dashboard/epics/createchilditem') }}">
            @csrf
                ...
                <div class="card-body">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-md-6 text-right">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm createchilditembutton">Save</button>
                        </div>
                    </div>
                </div>
            </div>
...
$('.classcreatechilditemform').on('submit',(function(e) {
