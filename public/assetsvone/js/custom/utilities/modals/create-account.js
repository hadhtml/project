        ...
        init: function() {
            ...
            (t = document.querySelector("#kt_create_account_stepper")) && (i = t.querySelector("#kt_create_account_form"), 
                ...
                4 === r.getCurrentStepIndex() ? (o.classList.remove("d-none"), 
                	...
                	a.classList.add("d-none")) : (o.classList.remove("d-inline-block"), o.classList.remove("d-none"), 
                ...
                fields: {
                    ...
                    level_three: {
                        validators: {
                            notEmpty: {
                                message: "Level Three is required"
                            }
                        }
                    }
                },
                ...
                s[2].validate().then((function(t) {
                    ...
                    console.log("validated!"), "Valid" == t ? (e.preventDefault(), o.disabled = !0, 
                    	o.setAttribute("data-kt-indicator", "on"), setTimeout((function() {
