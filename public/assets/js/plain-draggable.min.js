...
var PlainDraggable = function(t) {
    ...
    function Vt(t, e) {
        ...
        if (e.left !== n.left || e.top !== n.top) {
            var r = t.htmlOffset;
            return t.elementStyle[ft] = "" + (e.top + r.top) + "px 0px 0px " + (e.left + r.left) + "px", !0
    ...
    var ee = function() {
        function t(e, n) {
            ...
            if (e instanceof SVGElement && (i = e.ownerSVGElement)) {
                ...
                l && (o = !1), !n.leftTop && ft ? (l && (e.style[l] = "inset"), r.initElm = Zt, r.moveElm = Vt) : (l && (e.style[l] = "left, top"), r.initElm = $t, r.moveElm = Gt)
            }
    ...
    var re = function() {
        ct = P.getName("transitionProperty"), ft = P.getName("inset"), dt = lt.style.cursor, (pt = P.getName("userSelect")) && (vt = lt.style[pt]);
        var t = {},
            e = void 0;
