(function ($) {
    ...
    splitTextLines.forEach((splitTextLine) => {
        const tl3 = gsap.timeline({ scrollTrigger: { trigger: splitTextLine, start: "top 90%", duration: 2, end: "bottom 60%", scrub: false, markers: false, toggleActions: "play none none none" } });
        const itemSplitted = new SplitText(splitTextLine, { type: "lines" });
        gsap.set(splitTextLine, { perspective: 400 });
        itemSplitted.split({ type: "lines" });
        tl3.from(itemSplitted.lines, { duration: 1, delay: 0.5, opacity: 0, rotationX: -80, force3D: true, transformOrigin: "top center -50", stagger: 0.1 });
    });
    ...
    all_buttons.forEach((btn) => {
        if (!btn.classList.contains("banner-btn")) {
            gsap.from(btn, { scrollTrigger: { trigger: btn, start: "top center+=150", markers: false }, opacity: 0, y: -70, ease: "bounce", duration: 1.5 });
        }
    });
    let imageTl = gsap.timeline({ scrollTrigger: { trigger: ".animet-images", start: "top bottom", markers: false, scrub: 1, end: "bottom center" } });
    imageTl.to(".animet-images img", { scale: 1.2, duration: 1 });
    ...
    var swiper = new Swiper(".home3-testimonial-slider", {
        ...
        effect: "fade",
        fadeEffect: { crossFade: true },
        pagination: { el: ".franctional-pagi3", type: "fraction" },
    ...
    var swiper = new Swiper(".home3-team-slider", {
        ...
        breakpoints: { 280: { slidesPerView: 1 }, 386: { slidesPerView: 1 }, 576: { slidesPerView: 2 }, 768: { slidesPerView: 3 }, 992: { slidesPerView: 3 }, 1200: { slidesPerView: 4 }, 1400: { slidesPerView: 4 } },
    });
    var swiper = new Swiper(".gallery-slider", {
        speed: 1500,
        spaceBetween: 0,
        autoplay: { delay: 2500, disableOnInteraction: false },
        breakpoints: { 280: { slidesPerView: 1 }, 386: { slidesPerView: 2 }, 576: { slidesPerView: 2 }, 768: { slidesPerView: 3 }, 992: { slidesPerView: 3 }, 1200: { slidesPerView: 4 }, 1400: { slidesPerView: 5 } },
    });
    var swiper = new Swiper(".home3-pricing-slider", { slidesPerView: 1, speed: 2000, spaceBetween: 25, navigation: { nextEl: ".next-5", prevEl: ".prev-5" } });
    var swiper = new Swiper(".home4-award-slider", {
        ...
        fadeEffect: { crossFade: true },
        autoplay: { delay: 2500, disableOnInteraction: false },
        pagination: { el: ".franctional-pagi6", type: "fraction" },
        navigation: { nextEl: ".next-1", prevEl: ".prev-1" },
    });
    var swiper = new Swiper(".home4-work-slider", {
        ...
        pagination: { el: ".work-fractional-pagi", type: "fraction" },
    ...
    var swiper = new Swiper(".home6-testimonial-slider", {
        ...
        spaceBetween: 25,
        navigation: { nextEl: ".next-1", prevEl: ".prev-1" },
        breakpoints: { 280: { slidesPerView: 1 }, 386: { slidesPerView: 1 }, 576: { slidesPerView: 1 }, 768: { slidesPerView: 2 }, 992: { slidesPerView: 2 }, 1200: { slidesPerView: 3 }, 1400: { slidesPerView: 3 } },
    });
    var swiper = new Swiper(".home6-performance-slider", {
        ...
        autoplay: { delay: 2500, disableOnInteraction: false },
        navigation: { nextEl: ".next-2", prevEl: ".prev-2" },
        pagination: { el: ".pagination1", clickable: "true" },
        breakpoints: { 280: { slidesPerView: 1 }, 386: { slidesPerView: 1 }, 576: { slidesPerView: 1 }, 768: { slidesPerView: 2 }, 992: { slidesPerView: 2 }, 1200: { slidesPerView: 2 }, 1400: { slidesPerView: 2 } },
    });
    var swiper = new Swiper(".home6-blog-slider", {
        ...
        autoplay: { delay: 2500, disableOnInteraction: false },
        navigation: { nextEl: ".next-3", prevEl: ".prev-3" },
        breakpoints: { 280: { slidesPerView: 1 }, 386: { slidesPerView: 1 }, 576: { slidesPerView: 1 }, 768: { slidesPerView: 2 }, 992: { slidesPerView: 3 }, 1200: { slidesPerView: 3 }, 1400: { slidesPerView: 3 } },
    });
    ...
    var swiper = new Swiper(".pf-showcase-slider", { slidesPerView: 1, speed: 1500, spaceBetween: 25, effect: "fade", mousewheel: { invert: false }, navigation: { nextEl: ".next-16", prevEl: ".prev-16" } });
    ...
    const scScrollTl = gsap.timeline({ scrollTrigger: { trigger: ".scroll-sec-title", start: "top center", endTrigger: ".scroll-sec-title-end", end: "bottom top", toggleActions: "restart pause reverse pause", scrub: 1 } });
    scScrollTl.to(".scroll-sec-title", { y: 1500, duration: 10, opacity: 0 });
    const slider2 = jQuery(".work-flow-group");
    slider2.slick({ slidesToShow: 1, slidesToScroll: 1, fade: true, cssEase: "cubic-bezier(0.7, 0, 0.3, 1)" });
    ...
    ScrollTrigger.create({ trigger: "#trigger-route-1", animation: drawLine, start: "-10% 0", end: "120% 100%", scrub: 4 });
    drawLine.fromTo("#route-1", { drawSVG: "0%" }, { duration: 6, drawSVG: "100%" });
    let drawLine2 = gsap.timeline();
    ScrollTrigger.create({ trigger: "#solution-section", animation: drawLine2, start: "-10% 0", end: "120% 100%", scrub: 4 });
    drawLine2.fromTo("#route-2", { drawSVG: "0%" }, { duration: 6, drawSVG: "100%" });
    let drawLine3 = gsap.timeline();
    ScrollTrigger.create({ trigger: "#trigger-route-3", animation: drawLine3, start: "-10% 0", end: "105% 100%", scrub: 4 });
    drawLine3.fromTo("#route-3", { drawSVG: "0%" }, { duration: 1, drawSVG: "100%" });
        ...
        const actl = gsap.timeline({
            scrollTrigger: {
                ...
                onUpdate: (self) => {
                    ...
                    if (pageIndicator) pageIndicator.textContent = `${currentPage}/${totalProcesses}`;
                },
            },
        });
        gsap.to(".progress-bar", { strokeDashoffset: 0, duration: 5, ease: "linear" });
    }
})(jQuery);
